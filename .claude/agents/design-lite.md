---
name: design-lite
description: Small visual tweaks on a cheap fast model — spacing, colors, typography, hover states, single-component styling. Prefer this over 'design' when NO new pages/layouts/sections are being created. Escalate to 'design' for anything that adds structure or needs design judgement.
